...
describe('conanswapV3Pool', () => {
  ...
  let pool0: MockTimeconanswapV3Pool
  let pool1: MockTimeconanswapV3Pool
  ...
  let swapTargetCallee: TestconanswapV3Callee
  let swapTargetRouter: TestconanswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeconanswapV3Pool, any]> => {
