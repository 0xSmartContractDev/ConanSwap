...
import { conanswapV3PoolSwapTest } from '../typechain/conanswapV3PoolSwapTest'
...
describe('conanswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('conanswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as conanswapV3PoolSwapTest
          ...
          let tester: conanswapV3PoolSwapTest
