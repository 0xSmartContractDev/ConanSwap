...
export function createPoolFunctions({
  ...
  swapTarget: TestconanswapV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeconanswapV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestconanswapV3Router
  poolInput: MockTimeconanswapV3Pool
  poolOutput: MockTimeconanswapV3Pool
}): MultiPoolFunctions {
