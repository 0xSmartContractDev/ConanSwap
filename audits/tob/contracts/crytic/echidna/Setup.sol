...
import '../../../../../contracts/conanswapV3Factory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // since this is what the conanswap factory will do when you create the pool
...
contract Setupconanswap {
    conanswapV3Pool public pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    conanswapV3Factory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new conanswapV3Factory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = conanswapV3Pool(factory.createPool(address(token0), address(token1), _fee));
        pool.initialize(_startPrice);
    }
}

contract conanswapMinter {
    ...
    function setPool(conanswapV3Pool _pool) public {
        pool = _pool;
    }
